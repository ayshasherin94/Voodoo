    ...
    <i class="menu_close fa fa-times fa-lg"></i>
        ...
        <main class="content">
            <div class="content_inner">
                    ...
                    <h1><a href="index.html"><img src="globe.gif" alt="home" width="60px" height="60px"/></a>THE REVELATION<a id="btnEmpty" href="shoppingcart.php?action=empty"><img src="cart.png" alt="cart" align="right"/ height="50px" width="50px">{0}</h1></a>
                </div>
